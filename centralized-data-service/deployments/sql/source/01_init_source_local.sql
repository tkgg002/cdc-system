-- gpay-postgres-source — bootstrap sample source data cho E2E test.
-- Auto-load by Postgres init at first start (mounted to /docker-entrypoint-initdb.d/).
-- Phase 01 split E2E — workspace feature-multi-pg-isolation-e2e.
