...
-- ============================================================
-- DISABLED 2026-05-11: 10 pilot rows + create_all_pending_cdc_tables() là dev demo
-- (goopay_wallet/payment/order/main/legacy). Production không có các source DB này.
-- Migration 035 fan-out các row này sang cdc_system.source_object_registry +
-- shadow_binding + master_binding → ghost data trong control plane.
